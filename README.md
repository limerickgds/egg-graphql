...
[codecov-image]: https://img.shields.io/codecov/c/github/eggjs/egg-graphql.svg?style=flat-square
...
exports.graphql = {
  ...
  graphiql: true,
  // graphQL 路由前的拦截器
  onPreGraphQL: function* (ctx) {},  // TODO
  // 开发工具 graphiQL 路由前的拦截器，建议用于做权限操作(如只提供开发者使用)
  onPreGraphiQL: function* (ctx) {}, // TODO
};
```
